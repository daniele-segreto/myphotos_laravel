...
<head>
    ...
    <script type="text/javascript">
        // Questi import erano stati inseriti per verificare l'errore relativo al mancato building di site.css (vedi anche vite.js)
        // info: https://chat.openai.com/c/b63dab39-3bd4-46df-87bf-b519269e3391
        // import $ from 'jquery';
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (var i = data.length - 1; i >= 0; i--) {
                        ...
                        $('.grid').append('<div class="grid-item"><img src="' + data[i].url +
                            '" alt="" srcset=""></div>');
                    }
